...
mixin _$TestViewModel on _TestViewModelBase, Store {
  ...
  final _$testDataAtom = Atom(name: '_TestViewModelBase.testData');

  @override
  TestModel get testData {
    _$testDataAtom.reportRead();
    return super.testData;
  }

  @override
  set testData(TestModel value) {
    _$testDataAtom.reportWrite(value, super.testData, () {
      super.testData = value;
    });
  }
  ...
  dynamic getData() {
    final _$actionInfo = _$_TestViewModelBaseActionController.startAction(
        name: '_TestViewModelBase.getData');
    try {
